...
def train_yolo():
    ...
    validate_labels(os.path.join(base_dir, "hammer_dataset", "train/labels"), num_classes=3)  # Adjust `num_classes`
    validate_labels(os.path.join(base_dir, "hammer_dataset", "valid/labels"), num_classes=3)  # Adjust `num_classes`
