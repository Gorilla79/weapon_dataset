...
# Dataset URLs
dataset_urls = [
    "https://universe.roboflow.com/ds/4EiFIYVhsq?key=ugDB0SSmFg",
    "https://universe.roboflow.com/ds/Ab4kZuT5UU?key=PslIuj6ul3",
    "https://universe.roboflow.com/ds/RkxwQROR5c?key=FuoFN1CqUj",
    "https://universe.roboflow.com/ds/D2NUHIPTdY?key=GF6eRRnmey",
    "https://universe.roboflow.com/ds/q4Dy3IROYg?key=cDvwZj45BV"
]

# Paths
dataset_dir = os.path.join(base_dir, "datasets")
unified_dataset_dir = os.path.join(base_dir, "bat_dataset")
...
yaml_path = os.path.join(unified_dataset_dir, "bat_data.yaml")
