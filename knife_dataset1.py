...
# Dataset URLs
dataset_urls = [
    "https://universe.roboflow.com/ds/9gZa91vDUP?key=bWtRPzG2le",
    "https://universe.roboflow.com/ds/tLxfBwM69Y?key=aMuIBIL1Rh",
    "https://universe.roboflow.com/ds/SmfiTVG9DA?key=8DQtq0k8rB",
    "https://universe.roboflow.com/ds/d3na4lIAiZ?key=Ia0kugnvFX",
    "https://universe.roboflow.com/ds/AjnmuShlUs?key=1A3nofdylv"
]

# Paths
dataset_dir = os.path.join(base_dir, "datasets")
unified_dataset_dir = os.path.join(base_dir, "knife_dataset")
...
yaml_path = os.path.join(unified_dataset_dir, "knife_data.yaml")
